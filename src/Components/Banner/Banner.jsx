      ...
      <div className="flex flex-col-reverse md:flex-row justify-center w-11/12 mx-auto my-10 md:my-20  ">
        <div className="flex-1 flex flex-col space-y-4 justify-center ">
          <div className="flex md:justify-start justify-center ">
            <button className="flex items-center gap-2 btn text-[#4F39F6] bg-[#E1E7FF] rounded-full w-80 transition transform hover:-translate-y-1 ">
          ...
          <div className="flex space-x-5 justify-center md:justify-start ">
            <button className="btn btn-primary bg-[#4F39F6] rounded-full transition transform hover:-translate-y-1">
              Explore Products
            </button>
            <button className="flex items-center gap-2 btn text-[#4F39F6] bg-transparent border border-[#4F39F6] rounded-full transition transform hover:-translate-y-1 ">
              <img src={PlayImg} alt="" className="items-center" />
              Watch Demo
            </button>
          </div>
        </div>
        <div className="flex-1 flex justify-center md:justify-end pb-4 transition transform hover:translate-y-0.5  ">
